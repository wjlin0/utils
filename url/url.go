...
// StringNoPath returns string without path
...
// StringPathNoQuery returns string without path and query
func (u *URL) StringPathNoQuery() string {
	var buff bytes.Buffer
	if u.Scheme != "" && u.Host != "" {
		buff.WriteString(u.Scheme + "://")
	}
